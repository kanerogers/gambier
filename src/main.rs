        ...
        *control_flow = ControlFlow::Poll;
        match event {
            ...
            winit::event::Event::MainEventsCleared => unsafe {
                let render_fence = &context.sync_structures.render_fence;
                let present_semaphore = &context.sync_structures.present_semaphore;
                let render_semaphore = &context.sync_structures.render_semaphore;
                ...
                let (swapchain_image_index, _) = context
                    .swapchain
                    .loader
                    .acquire_next_image(
                ...
                let render_pass_begin_info = vk::RenderPassBeginInfo::builder()
                    ...
                    .framebuffer(context.framebuffers[swapchain_image_index as usize])
                    .render_area(context.swapchain.resolution.into())
                ...
                let present_info = vk::PresentInfoKHR::builder()
                    .swapchains(std::slice::from_ref(&context.swapchain.swapchain))
